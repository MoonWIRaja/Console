...
const cardClass =
    'sc-card h-full min-h-[96px] w-full p-4';
        ...
        <section className={`${cardClass} min-w-0 overflow-hidden`}>
            <div className={'flex h-full min-w-0 flex-col justify-between gap-4 xl:flex-row xl:items-center'}>
                <div className={'flex min-w-0 items-center gap-4'}>
                    <div
                        className={
                            'flex h-16 w-16 shrink-0 items-center justify-center rounded-[18px] border-2 border-[#2D4A3E] bg-[#F5EFD5] text-[#2D4A3E]'
                        }
                    >
                    ...
                    <div className={'min-w-0'}>
                        <div className={'flex flex-wrap items-center gap-2'}>
                            <h2 className={'truncate text-2xl font-black tracking-tight text-[#742220]'}>{title}</h2>
                            {community?.roleAssigned ? (
                                ...
                                <span
                                    className={
                                        'rounded-lg border border-[#2D4A3E] bg-[rgba(45,74,62,0.1)] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#2D4A3E]'
                                    }
                                >
                                    In Server
                                </span>
                        ...
                        <p className={'mt-1 text-xs text-[rgba(116,34,32,0.58)]'}>{description}</p>
                    </div>
                </div>
                ...
                <button
                    ...
                    className={
                        'inline-flex h-11 w-full min-w-0 items-center justify-center rounded-full border border-[#2D4A3E] bg-[#F5EFD5] px-5 text-[11px] font-semibold uppercase tracking-wide text-[#742220] transition-all duration-300 hover:border-[#2D4A3E] hover:bg-[rgba(45,74,62,0.1)] xl:ml-auto xl:w-auto xl:min-w-[11rem] xl:shrink-0 disabled:cursor-not-allowed disabled:opacity-50'
                    }
                >
                    {buttonLabel}
                </button>
