...
export default () => {
    ...
    const handleRequest = ({ email }: RequestValues, { setSubmitting }: FormikHelpers<RequestValues>) => {
        clearFlashes();
    ...
    const handleReset = (
        { pin, password, passwordConfirmation }: ResetValues,
                        ...
                        <div className='rounded-xl bg-[color:var(--card)] p-8'>
                            {mode === 'request' ? (
                                ...
                                <Formik
                                    ...
                                    initialValues={{ pin: '', password: '', passwordConfirmation: '' }}
                                    validationSchema={object().shape({
                                        pin: string()
                                        ...
                                        <Form className='space-y-5'>
                                            <div className='group space-y-1'>
                                                ...
                                                {errors.pin && touched.pin && (
                                                    <div className='text-[10px] font-bold text-red-400'>{errors.pin}</div>
                                                )}
                                            </div>
                                            <div className='group space-y-1'>
                                                <label
                                                ...
                                                {errors.password && touched.password && (
                                                    <div className='text-[10px] font-bold text-red-400'>{errors.password}</div>
                                                )}
                                            </div>
                                            <div className='group space-y-1'>
                                                <label
