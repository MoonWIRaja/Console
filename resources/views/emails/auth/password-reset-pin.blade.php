                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td valign="middle">
                                                    ...
                                                    <p style="margin:6px 0 0;font-size:12px;line-height:1.6;color:#94a3b8;">Password access and recovery workflow.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td valign="top" align="right">
                                        <span style="display:inline-block;padding:9px 14px;border-radius:999px;background-color:#f0b90b;color:#111827;font-size:10px;line-height:1;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;box-shadow:inset 0 1px 0 rgba(255,255,255,0.28), 0 10px 18px rgba(15,23,42,0.18);">Reset PIN</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5decf;border-radius:18px;background-color:#fffcf5;margin-bottom:20px;box-shadow:0 12px 28px rgba(148,163,184,0.14);">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0;font-size:12px;line-height:1.6;color:#6b7280;">Password Recovery</p>
                                    </td>
                                </tr>
                            </table>
                            <h1 style="margin:0 0 12px;font-size:28px;line-height:1.25;color:#111827;">Password reset request</h1>
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#4b5563;">
                                Hi {{ $recipientName }}, use this 6-digit PIN to reset your password.
                            </p>
