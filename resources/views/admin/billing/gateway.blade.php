...
@section('content')
    ...
    <div class="callout callout-info">
        @if (config('billing.gateway.manual_mode', true))
            ...
            <p class="admin-note-tight">Hosted providers such as BCL stay configured for later use, but manual mode overrides them for all new checkout attempts.</p>
        @elseif (config('billing.gateway.default') === 'bcl')
            ...
            <p class="admin-note-tight">Manual billing remains available as a fallback when you need to disable hosted checkout temporarily.</p>
        @else
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Choose the provider new invoices should use when manual mode is disabled.</p>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Keep this enabled to block hosted checkout and force invoice review inside admin billing.</p>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Administrative switch for the internal manual provider record used by invoices.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Enable this before setting BCL as the default hosted checkout provider.</p>
                    </div>
                    <div class="col-md-8 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Use the public BCL form page URL, for example <code>https://merchant.bcl.my/form/billing</code>. The panel opens this page with a <code>GET</code> request and passes the fields listed below.</p>
                    </div>
                </div>

                <div class="callout callout-warning admin-text-no-top">
                    <p class="admin-no-margin"><strong>BCL custom field contract:</strong> your BCL form must accept these hidden fields exactly as named: <code>panel_checkout_reference</code>, <code>panel_invoice_id</code>, <code>panel_invoice_number</code>, <code>panel_amount</code>, <code>panel_currency</code>, <code>panel_signature</code>.</p>
                    <p class="admin-note-tight">Expected payer fields for the hosted form are <code>name</code>, <code>email</code>, <code>phone</code>, <code>amount</code>, <code>currency</code>, and <code>description</code>.</p>
                    <p class="admin-note-tight">Webhook URL to register in BCL: <code>{{ $bclWebhookUrl }}</code></p>
                </div>

                <div class="box box-default admin-gap-bottom-xl">
                    <div class="box-header with-border">
                        <h3 class="box-title">BCL Copy &amp; Paste Setup</h3>
                    </div>
                    <div class="box-body">
                        <p class="text-muted admin-text-no-top">Copy these values directly into your BCL form settings. The redirect URLs return the customer to the billing page, while the webhook URL is what lets the panel verify payment and start provisioning.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <p class="text-muted small admin-help-tight">Create each of these in BCL as <code>Text Input</code>, enabled, with the same label and label ID.</p>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Expected Payer Fields</label>
                                <textarea class="form-control" rows="7" readonly onclick="this.select();">{{ $bclPayerFields }}</textarea>
                                <p class="text-muted small admin-help-tight">These are the values the panel sends to the BCL form during checkout.</p>
                            </div>
                        </div>

                        <div class="callout callout-info admin-box-tight">
                            <p class="admin-no-margin"><strong>Note:</strong> BCL <em>Test Webhook</em> may still return <code>422</code> because the sample payload does not include a real <code>panel_checkout_reference</code>. Validate with a real checkout transaction and then review <strong>Webhook Events</strong> in admin billing.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Customer invoices and hosted checkout totals are currently standardised around <code>MYR</code>.</p>
                    </div>
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">How early renewal invoices are prepared before the due window.</p>
                    </div>
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Hours after unpaid renewal before the server is suspended.</p>
                    </div>
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Hours after due date before an overdue server is deleted.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Hours after a full base refund before the refunded server is suspended.</p>
                    </div>
                    <div class="col-md-3 form-group">
                        ...
                        <p class="text-muted small admin-help-tight">Hours after refund suspension before the refunded server is deleted.</p>
                    </div>
                </div>
            </div>
