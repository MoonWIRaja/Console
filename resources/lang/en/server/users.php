...
return [
    'permissions' => [
        ...
        'subdomain_read' => 'Allows access to the server subdomain management section.',
        'subdomain_create' => 'Allows a user to create DNS subdomains for the server.',
        'subdomain_delete' => 'Allows a user to delete DNS subdomains for the server.',
