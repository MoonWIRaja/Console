...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'down_detector:server:auto_restart_default_enabled',
        'down_detector:server:auto_restart_delay_seconds',
        'down_detector:server:auto_restart_max_attempts',
        'down_detector:server:auto_restart_window_minutes',
