...
return [
    ...
    'fiuu' => [
        ...
        'return_url' => env('BILLING_FIUU_RETURN_URL'),
        ...
        'checkout_urls' => [
            'production' => env('BILLING_FIUU_CHECKOUT_URL', 'https://pay.fiuu.com/RMS/pay'),
            'sandbox' => env('BILLING_FIUU_SANDBOX_CHECKOUT_URL', 'https://sandbox-payment.fiuu.com/RMS/pay'),
        ],
